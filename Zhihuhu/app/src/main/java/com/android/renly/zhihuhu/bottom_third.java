...
public class bottom_third extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bottom_third);
        //初始化底部布局
        initBottomView();
        //设置监听
        setListener();
    ...
    private void initBottomView() {
        ...
        tv_bottom_third.setTextColor(Color.parseColor("#3186CF"));
        Drawable top_img = getResources().getDrawable(R.drawable.storeblue);
        top_img.setBounds(0, 0, top_img.getMinimumWidth(), top_img.getMinimumHeight());
        tv_bottom_third.setCompoundDrawables(null, top_img, null, null);
    }
