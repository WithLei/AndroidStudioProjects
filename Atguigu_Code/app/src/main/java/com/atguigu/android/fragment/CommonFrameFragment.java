...
public class CommonFrameFragment extends BaseFragment {
    ...
    protected void initData() {
        ...
        //准备数据
        datas = new String[]{"OKHttp", "nativeJsonPrase", "Gson", "FastJson", "xUtils3", "Afinal", "Volley","Eventbus","Butterknife","Imageloader","Picasso","Retrofit2", "Fresco", "Glide", "greenDao", "RxJava","jcvideoplayer", "pulltorefresh", "Expandablelistview", "UniversalVideoView", "....."};
